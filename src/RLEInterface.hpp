...
class RLEInterface : public CompressInterface {
  public:
    /**
     * Construct a RLEInterface object
     *
     * @param codec_name: the name of the codec, default is
     * "simple9_rle"
     */
    RLEInterface(const std::string &codec_name = "simple9_rle");

    ~RLEInterface() override = default;
